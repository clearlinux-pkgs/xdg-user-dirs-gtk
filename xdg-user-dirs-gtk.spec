...
Version  : 0.14
Release  : 17
URL      : https://download.gnome.org/sources/xdg-user-dirs-gtk/0.14/xdg-user-dirs-gtk-0.14.tar.xz
Source0  : https://download.gnome.org/sources/xdg-user-dirs-gtk/0.14/xdg-user-dirs-gtk-0.14.tar.xz
...
%prep
%setup -q -n xdg-user-dirs-gtk-0.14
cd %{_builddir}/xdg-user-dirs-gtk-0.14
pushd ..
cp -a xdg-user-dirs-gtk-0.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738353702
